  ...
  return (
    ...
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 mb-1 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-10 justify-center">
        <a href="#" className="group">
          <div className="aspect-h-1 aspect-w-1 w-40 h-40 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
            <img src={Ap} alt="A+ blood group" className="h-full w-full object-cover object-center group-hover:opacity-75" />
          </div>
        ...
        <a href="#" className="group">
          <div className="aspect-h-1 aspect-w-1 w-40 h-40 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
            <img src={Am} alt="A- blood group" className="h-full w-full object-cover object-center group-hover:opacity-75" />
          </div>
          <h3 className="mt-4 text-sm text-gray-700">A-</h3>
        ...
        <a href="#" className="group">
          <div className="aspect-h-1 aspect-w-1 w-40 h-40 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
            <img src={Op} alt="O+ blood group" className="h-full w-full object-cover object-center group-hover:opacity-75" />
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-10 mt-10 justify-center">
        <a href="#" className="group">
          <div className="aspect-h-1 aspect-w-1 w-40 h-40 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
            <img src={Om} alt="O- blood group" className="h-full w-full object-cover object-center group-hover:opacity-75" />
          </div>
          <h3 className="mt-4 text-sm text-gray-700">O-</h3>
        ...
        <a href="#" className="group">
          <div className="aspect-h-1 aspect-w-1 w-40 h-40 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
            <img src={ABm} alt="AB+ blood group" className="h-full w-full object-cover object-center group-hover:opacity-75" />
          </div>
        ...
        <a href="#" className="group">
          <div className="aspect-h-1 aspect-w-1 w-40 h-40 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
            <img src={ABp} alt="AB- blood group" className="h-full w-full object-cover object-center group-hover:opacity-75" />
          </div>
          <h3 className="mt-4 text-sm text-gray-700">AB-</h3>
